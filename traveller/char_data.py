...
SKILL_TYPES = {"BT": 0, "PD": 1, "Serv": 2, "Spec": 3, "Adv": 4, "Off": 5}
...
SKILLS = {
    ...
    ("Drifter", "Barbarian"): (("Animals", 0), ("Carouse", 0), ("Melee", 0),
        ("Stealth", 0), ("Seafarer", 0), ("Survival", 0), ("Str", 1),
        ("End", 1), ("Dex", 1), ("Jack of all Trades", 0),
        ("End", 1), ("Int", 1), ("Athletics", 0),
    ...
    ("Drifter", "Wanderer"): (("Athletics", 0), ("Deception", 0), ("Recon", 0),
        ("Stealth", 0), ("Streetwise", 0), ("Survival", 0), ("Str", 1),
        ("End", 1), ("Dex", 1), ("Jack of all Trades", 0),
        ("End", 1), ("Int", 1), ("Athletics", 0),
        ("Melee (unarmed)", 0), ("Recon", 0), ("Streetwise", 0), ("Stealth", 0),
    ...
    ("Drifter", "Scavenger"): (("Pilot", 0), ("Mechanic", 0), ("Astrogation", 0),
        ("Vacc Suit", 0), ("Zero-G", 0), ("Gun Combat", 0), ("Str", 1),
        ("End", 1), ("Dex", 1), ("Jack of all Trades", 0),
        ("End", 1), ("Int", 1), ("Athletics", 0),
        ("Melee (unarmed)", 0), ("Recon", 0), ("Streetwise", 0), ("Stealth", 0),
    ...
    ("Entertainer", "Performer"): (("Art", 0), ("Art", 0), ("Carouse", 0),
        ...
        ("Art", 0), ("Deception", 0), ("Science (Any)", 0), ("Streetwise", 0),
        ("Diplomat", 0)),
...
RANKS = {
    ("Warden", "Enforcer"):
        (None, ("Occult", 1), None, ("Investigate", 1), None, ("Leadership", 1), ("Social", 1)),
    ("Warden", "Investigator"):
        (None, ("Occult", 1), None, ("Investigate", 1), None, ("Leadership", 1), ("Social", 1)),
    ("Warden", "Researcher"):
        (None, ("Occult", 1), None, ("Investigate", 1), None, ("Leadership", 1), ("Social", 1)),
    ("Agent", "Law Enforcement"):
        (None, ("Streetwise", 1), None, None, ("Investigate", 1), ("Admin", 1), ("Social", 1)),
    ("Agent", "Intelligence"):
